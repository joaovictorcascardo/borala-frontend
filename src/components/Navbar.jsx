  ...
  return (
    <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-blue-100/80">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center gap-2">
        <NavLink to="/" aria-label="Borala — página inicial" className="flex items-center gap-2 mr-3 shrink-0">
        ...
        <nav aria-label="Menu principal" className="flex items-center gap-0.5 flex-1 overflow-x-auto">
          <NavLink to="/rides" end className={linkClass} aria-label="Caronas">
          ...
          <NavLink to="/events" end className={linkClass} aria-label="Eventos">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <NavLink to="/my-rides" end className={linkClass} aria-label="Minhas caronas">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <NavLink to="/my-bookings" end className={linkClass} aria-label="Minhas reservas">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
            </svg>
          ...
          <NavLink to="/vehicles" end className={linkClass} aria-label="Meus veículos">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div className="flex items-center gap-1.5 ml-2 shrink-0">
          <button
            ...
            aria-label={`Perfil de ${firstName || "usuário"}`}
          ...
          >
            <div className="w-7 h-7 bg-blue-100 rounded-full flex items-center justify-center shrink-0" aria-hidden="true">
