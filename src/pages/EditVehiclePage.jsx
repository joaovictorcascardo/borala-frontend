        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block sm:col-span-2">
              ...
              <input className="form-input mt-1.5 bg-slate-50 text-slate-400 cursor-not-allowed" value={licensePlate} disabled />
            ...
            <label className="block">
              ...
              <input className="form-input mt-1.5" value={brand} onChange={(e) => setBrand(e.target.value)} required />
            </label>
            <label className="block">
              <span className="text-sm font-semibold text-slate-700">Modelo</span>
              <input className="form-input mt-1.5" value={model} onChange={(e) => setModel(e.target.value)} required />
            </label>
            <label className="block">
              <span className="text-sm font-semibold text-slate-700">Cor</span>
              <input className="form-input mt-1.5" value={color} onChange={(e) => setColor(e.target.value)} required />
            </label>
            <label className="block">
              <span className="text-sm font-semibold text-slate-700">Ano</span>
              <input type="number" className="form-input mt-1.5" value={year} onChange={(e) => setYear(e.target.value)} required />
            </label>
            <label className="block">
              <span className="text-sm font-semibold text-slate-700">Vagas disponíveis</span>
              <input type="number" className="form-input mt-1.5" min={1} value={seats} onChange={(e) => setSeats(e.target.value)} required />
            </label>
          </div>
